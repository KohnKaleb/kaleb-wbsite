          ...
          <Text id="carouselContent" className="carousel slide" data-bs-ride="carousel">
            <div className="carousel-inner" role="listbox">
              <div className="carousel-item active text-center p-4">
                <p style={{fontSize: "20px"}}> I've been coding for over four years dabbling in mobile development,
              ...
              <div className="carousel-item text-center p-4">
                <p style={{fontSize: "20px"}}> I am also a member of the Wisconsin Air National Guard and act as a maintenance analyst,
                    tracking maintenance trends, analyzing statistics and providing recommendations to leadership.
                </p>
              </div>
              <div className="carousel-item text-center p-4">
                <p style={{fontSize: "20px"}}> My Air Force experience has given me the opportunity to work with a variety of people and has taught me the importance of communication and teamwork, as well as statistical analysis and data visualization. I even had the opportunity
